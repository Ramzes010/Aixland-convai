...
var ASM_CONSTS = {
  4814496: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4814557: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4814621: function() {return Module.webglContextAttributes.powerPreference;},  
 4814679: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4814734: function($0) {performance.now = function() { return $0; };},  
 4814782: function($0) {performance.now = function() { return $0; };},  
 4814830: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _sendFeedback(character_id, session_id, thumbs_up, feedback_text) {
...
/** @type {function(...*):?} */
var dynCall_iifffffffi = Module["dynCall_iifffffffi"] = createExportWrapper("dynCall_iifffffffi");
